...
### Comparação
  Comparando as respostas dos dois métodos, podemos ver que elas concordam entre si, por testes de hipóstese foi calculado um p valor de 0.96, que é alto e significa que não se descarta a hipótese nula, ou seja o resultado é pouco significante. Para esse valor de p valor podemos concluir também que o 0 estará dentro do intervalo de confiança e que o intervalo será pequeno, e para a análise de intervalo de confiança vemos que isso acontece, com um intervalo de confiança [-0.446; 0.41] com 95% de confiança, que significa que se há uma diferença entre os gols no domingo com os da quarta ela é insignificante (menos de 0.5 gols de diferença) com 95% de confiança. Olhando para análise com intervalo de confiança vemos que ela traz mais informações que a de teste de hipótese, pois além de dizer se o resultado é significante ou não, a análise traz também o intervalo de confiança. Portanto uma diferença de gols entre os domingos e as quartas, em média, pode existir, mas caso exista é muito pequena, insignificante.
