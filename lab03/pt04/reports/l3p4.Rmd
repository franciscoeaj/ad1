...
jogos_brasileirao_2017 %>% 
    ...
    tidy(conf.level = 0.95, 
         conf.int = TRUE)
```
Podemos afirmar com 95% de confiança que nos jogos do campeonato brasileiro que jogos que terminam com um vitorioso tem mails gols (no intervalo [0.212, 0.907]) que jogos que terminam empatados. Essa variação é pouco significativa (menor que um gol).
